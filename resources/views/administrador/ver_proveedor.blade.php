                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 d-grid gap-2">
                                <div class="btn-group">
                                    @if($dato->estatus == 1)
                                    <button class="btn btn-lg btn-default" onclick="suspenderProveedor('{{$dato->id}}')" title="Suspender"><i class="bi bi-sign-stop-fill"></i></button>
                                    ...
                                    @else
                                    <button class="btn btn-lg btn-success" onclick="activarProveedor('{{$dato->id}}')" title="Activar"><i class="bi bi-check-circle-fill"></i></button>
                                    <button class="btn btn-lg btn-primary" title="Enviar notificacion" data-toggle="modal" data-target="#modalMensaje" type="button" type="button"><i class="bi bi-envelope-at-fill"></i></button>
                                    @endif
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body flex-grow-1">
                <div class="row">
                    <div class="col-md-12">
                        <textarea name="p_mensaje" placeholder="Escribe un mensaje" id="p_mensaje" class="w-100" rows="10"></textarea>
                    </div>
                </div>
            </div>
