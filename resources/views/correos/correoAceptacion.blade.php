...
<head>
    <title>Solicitud de ingreso ACEPTADA</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h2>Qwikly - Solicitud de registro ACEPTADA</h2>
        </div>
        <div class="content text-center">
            <p>Felicidades <strong>{{ $nombre }}</strong> </p>
            <p>Su solicitud para formar parte de nuestra plataforma ha sido aceptada</p>
