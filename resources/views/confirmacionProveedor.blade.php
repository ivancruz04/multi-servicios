                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <img class="img-fluid img-proveedor" src="/img/check.png" width="15%" height="15%" alt="">
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <p>Un administrador revisara su información y en base a ella</p>
                                        <p>autorizará su acceso a la plataforma. La notificación será enviada al correo que proporcionó.</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <a class="btn btn-primary" href="/Qwikly/inicio" type="button"><i class="bi bi-house-fill"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
